...
function closeModifyPassword() {
  ...
  document.querySelector(
    ".modifyPassword_paragraph-alertWrongPass"
  ).style.display = "none";
  document.querySelector(
    ".modifyPassword_paragraph-alertNoMatch"
  ).style.display = "none";
}
...
function passwordCheckMatch() {
  if (
    ...
    if (
      ...
      document.querySelector(
        ".modifyPassword_paragraph-alertNoMatch"
      ).textContent = " No match between passwords";
      document.querySelector(
        ".modifyPassword_paragraph-alertNoMatch"
      ).style.display = "block";
    }
    ...
    document.querySelector(
      ".modifyPassword_paragraph-alertNoMatch"
    ).textContent = "Please type in the new passwords";
  }
}
